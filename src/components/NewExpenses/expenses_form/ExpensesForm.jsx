...
import clasess from "./ExpensesForm.module.css";
  ...
  render() {
    return (
      <form onSubmit={this.submitHandler.bind(this)}>
        <div className={clasess.new_expense__controls}>
          <div className={clasess.new_expense__control}>
            <label>Title</label>
            <input
              type="text"
        ...
        <div className={clasess.new_expense__actions}>
